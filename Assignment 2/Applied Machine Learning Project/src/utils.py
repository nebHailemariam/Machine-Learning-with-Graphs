YELP_TRAIN_DIR = "filtered_yelp_reviews_train.json"
YELP_DEV_DIR = "filtered_yelp_reviews_test.json"
YELP_TEST_DIR = "../data/yelp_reviews_test.json"
STOP_WORD_DIR = "../data/stopword.list"
