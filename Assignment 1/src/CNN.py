# -*- coding: utf-8 -*-
"""Amazon_Review_With_CNN.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17ev3TutnjST-verIGR7KU1JGg6l2HUzu
"""
...
class SentimentDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        indices = self.text_to_indices(text)[:self.max_length]
...
class SentimentCNN(nn.Module):
    def __init__(self, vocab_size, embed_dim, context_size):
        ...
        self.conv_1d = torch.nn.Conv1d(1, out_channels=100, kernel_size=3, stride=embed_dim, padding="valid")
        self.max_pooling_1d = torch.nn.MaxPool1d(100, stride=embed_dim)
        self.relu_1 = nn.ReLU()
        self.init_weights()

        self.fc_1 = nn.Linear(100, 2)
...
# class SentimentCNNWithEmbeddings(nn.Module):
#     def __init__(self, vocab_size, embed_dim, context_size):
#         super(SentimentCNNWithEmbeddings, self).__init__()

#         weights = (torch.rand(vocab_size, embed_dim) * 2) - 1
...
#         self.conv_1d = torch.nn.Conv1d(embed_dim, out_channels=100, kernel_size=3, stride=1, padding=1)
#         self.max_pooling_1d = torch.nn.MaxPool1d(100, stride=embed_dim)
#         self.relu_1 = nn.ReLU()
